...
OBJ_DEBUG = $(OBJDIR_DEBUG)/Main.o $(OBJDIR_DEBUG)/Bishop.o $(OBJDIR_DEBUG)/King.o $(OBJDIR_DEBUG)/Knight.o $(OBJDIR_DEBUG)/Pawn.o $(OBJDIR_DEBUG)/Piece.o $(OBJDIR_DEBUG)/Queen.o $(OBJDIR_DEBUG)/Rook.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/Main.o $(OBJDIR_RELEASE)/Bishop.o $(OBJDIR_RELEASE)/King.o $(OBJDIR_RELEASE)/Knight.o $(OBJDIR_RELEASE)/Pawn.o $(OBJDIR_RELEASE)/Piece.o $(OBJDIR_RELEASE)/Queen.o $(OBJDIR_RELEASE)/Rook.o
